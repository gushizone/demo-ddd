...
public class StockQryAppServiceImpl implements StockQryAppService {
    ...
    @Override
    public PagedRestResponse<StockApiRsp> queryByApi(PagingRestRequest<StockQryApiReq> req) {
        ...
        return PagedRestResponse.ok(stackPagedResult.getPage(), StockAppAssembler.toApiRsp(stackPagedResult.getRecords()));
    }
}
